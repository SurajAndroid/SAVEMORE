...
/**
 * Created by SURAJ on 9/8/2017.
 */

public class ProfileDTO {
    String  id, firstName, lastName, emailId, contactNo, city, address, pincode, otherContactNo, deviceId, status, registrationDate, isOtpVerified;
